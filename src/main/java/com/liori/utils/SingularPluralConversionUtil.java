...
public class SingularPluralConversionUtil {
    ...
    private static SingularPluralConversionUtil instance;

    private SingularPluralConversionUtil() {
        initialize();
    }

    public static String changeSinglarToPlural(String word) {
        return SingularPluralConversionUtil.getInstance().pluralize(word);
    }

    public static String changePluralToSinglar(String word) {
        return SingularPluralConversionUtil.getInstance().singularize(word);
    }
    ...
    private static SingularPluralConversionUtil getInstance() {
        if (instance == null) {
            instance = new SingularPluralConversionUtil();
        }
        return instance;
    }
